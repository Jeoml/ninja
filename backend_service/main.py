...
async def root():
    ...
    return {
        ...
        "services": {
            ...
            "agent_helper": {
                "topics": "GET /agent-helper/topics",
                "get_question": "GET /agent-helper/get-question?topic={topic}&difficulty={difficulty}",
                "record_response": "POST /agent-helper/record-response?session_id={id}&question_id={id}&user_answer={answer}",
                "session_responses": "GET /agent-helper/session-responses?session_id={id}",
                "session_performance": "GET /agent-helper/session-performance?session_id={id}"
            },
            "utility": {
                "health": "GET /health",
                "docs": "GET /docs"
